...
class AudioPlayerHandlerImpl extends BaseAudioHandler
  ...
  updateCurrentPlayerData(MusicModel musicModel, int index) {
    ...
    if (temp == null) baseScreenController.update();
    if (currentPlayerId == musicModel.track[index].url) {
      audioHandler.play();
      return;
    }

    currentPlayerId = musicModel.track[index].url;
    if (currentQueueId != musicModel.id) {
      currentQueueId = musicModel.id;
      List<MediaItem> mediaItems = [];
      musicModel.track.forEach((element) {
        mediaItems.add(MediaItem(
          id: element.url,
          title: element.name,
          album: musicModel.title,
          // artist: musicModel.scenarioAuthor.name,
          artUri: Uri.parse(musicModel.image),
    ...
    print("CURRENT $currentQueueId $currentPlayerId ");
  }
}
